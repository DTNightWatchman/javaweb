...
export async function invokeInterfaceInfoUsingPOST(
  ...
  return request<API.BaseResponsestring>('/api/interface/invoke', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listInterfaceByPageUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listInterfaceByPageUsingGETParams,
  options?: { [key: string]: any },
) {
