...
/** updateAkSk GET /api/user/updateAkSk */
export async function updateAkSkUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseboolean>('/api/user/updateAkSk', {
    method: 'GET',
    ...(options || {}),
  });
}

/** uploadUserAvatar POST /api/user/uploadAvatar */
export async function uploadUserAvatarUsingPOST(body: string, options?: { [key: string]: any }) {
